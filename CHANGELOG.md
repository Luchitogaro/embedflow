...
- **Lead GarSaaS (opcional)** — server action tras signup con contraseña o envío de magic link; `GARSAAS_LEADS_URL` + `GARSAAS_INTERNAL_LEADS_SECRET` (solo servidor). Ver repo GarSaaS `docs/sql/product_signups.sql`.
